...
## Backend
Python is the main programming language for the backend. FASTAPI framework is utilize for as my API. Will be hosted on Render for free usage and overlapped with the website.
## Knowledge Storage
